package com.jsonstore.googlemaproute;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private ArrayList<Object> MarkerPoints;
    private ArrayList<LatLng> latLngsList;
    private ArrayList<Marker> markerList;
    public final int PERMISSIONS_BUZZ_REQUEST = 0xABC;
    ...
    private void getPermission(){
        if (ContextCompat.checkSelfPermission(MapsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(MapsActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSIONS_BUZZ_REQUEST);
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                ...
                if (MarkerPoints.size() == 1) {
                    options.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)).title("Source");
