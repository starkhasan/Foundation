...
void main() {
  ...
  var response = List<User>.from(json.decode(jsonString).map((x) => User.fromJson(x)));
  for (var user in response) {
    ...
    print('Location -> ${user.address.geo.lat}, ${user.address.geo.lng}');
    print('Phone -> ${user.phone}');
    print('Website -> ${user.website}');
    print('Company Name -> ${user.company.name}');
    print('Catch Phrase -> ${user.company.catchPhrase}');
