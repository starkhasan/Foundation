void main(List<String> args) {
    /**
     * Negative Lookahead (?!)
     * Negative lookahead asset that first part of the expression not be followed by the lookahead expression
     * 
     ...
     * positive lookahead which tells the regular expression engine not to match The or the only if it's 
